        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">EMP Leave Request</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
     ...
     <!--table-->
      <div class="card shadow" style="background-color: #e6cbd2;text-align: center;">
              <div class="card-header">
                <h3 class="card-title font-weight-bold">EMP Leave Request</h3>
                ...
                <table id="example1" class="table table-bordered table-striped bg-light">
                    ...
                    <td>
                      <form method="POST" action="applyleave_update.php">
                        ...
                        <input type="hidden" name="id" value="<?php echo $result2['a_id'] ?>">
                    </td>
                    <td class="text-center">
                      <button class="btn btn-info" name="approved" type="submit">Approved</button>
                      <button class="btn btn-danger" name="rejected" type="submit">Rejected</button>
